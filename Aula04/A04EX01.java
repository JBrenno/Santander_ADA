...
public class A04EX01 {
    ...
    public static double[] custosCarro(double[] input) {
        ...
        double valorDistribuidora = input[1];
        double valorImpostos = input[2];

        double percentDistribuidora = arredondar(100 * valorDistribuidora / precoFinal);
        double percentImposto = arredondar(100 * valorImpostos/ precoFinal);

        return new double[]{percentDistribuidora, percentImposto};
